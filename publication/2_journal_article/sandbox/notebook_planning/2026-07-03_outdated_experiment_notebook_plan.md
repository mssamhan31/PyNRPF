# Archived 2026-07-03 Journal Article Notebook Experiment Plan v2

> **Status: superseded.** This plan describes the older m7/m8 correction-validation workflow.
> It is retained only as historical context and must not guide new implementation. The current
> source of truth is `2026-07-15_m9_pbm_experiment_notebook_prd.md` in this folder.
